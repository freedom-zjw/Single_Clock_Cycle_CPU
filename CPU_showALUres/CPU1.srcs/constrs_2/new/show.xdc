...
set_property PACKAGE_PIN W7 [get_ports {sm_duan[7]}]
set_property PACKAGE_PIN W6 [get_ports {sm_duan[6]}]
set_property PACKAGE_PIN U8 [get_ports {sm_duan[5]}]
set_property PACKAGE_PIN V8 [get_ports {sm_duan[4]}]
set_property PACKAGE_PIN U5 [get_ports {sm_duan[3]}]
set_property PACKAGE_PIN V5 [get_ports {sm_duan[2]}]
set_property PACKAGE_PIN U7 [get_ports {sm_duan[1]}]
set_property PACKAGE_PIN V7 [get_ports {sm_duan[0]}]
