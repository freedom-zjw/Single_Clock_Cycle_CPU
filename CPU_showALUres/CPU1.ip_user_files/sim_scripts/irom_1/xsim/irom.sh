...
#
# Generated by Vivado on Thu Jun 15 22:36:52 +0800 2017
...
# Script info
echo -e "irom.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L dist_mem_gen_v8_0_11 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot irom xil_defaultlib.irom xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim irom -key {Behavioral:sim_1:Functional:irom} -tclbatch cmd.tcl -log simulate.log
}
