...
#
# Generated by Vivado on Fri Jun 02 13:06:45 +0800 2017
...
xv_path="D:/viwado1/Vivado/2016.3"
...
# Script info
echo -e "dram.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L dist_mem_gen_v8_0_11 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dram xil_defaultlib.dram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim dram -key {Behavioral:sim_1:Functional:dram} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/viwado1/Vivado/2016.3/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
